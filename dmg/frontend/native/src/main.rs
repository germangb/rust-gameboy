use dmg_backend_rodio::apu::DmgSource;
use dmg_backend_sdl2::ppu::SdlVideo;
use dmg_lib::{
...
static ROM: &[u8] = include_bytes!(
    "../roms/Simpsons, The - Night of the Living Treehouse of Horror (U) [C][!].gbc"
);

...
impl Joypad {
    ...
    /// Return the generated interrupt (if any). Calling this method a second
    /// time will return None until a new interrupt is generated by pressing
    /// keys.
    pub fn take_int(&mut self) -> Option<Flag> {
        self.int.take()
    }
...
impl Device for Joypad {
    fn read(&self, addr: u16) -> u8 {
        ...
        match self.joyp & 0x30 {
            BTN_ROW_FLAG => BTN_ROW_FLAG | self.btn(),
            DIR_ROW_FLAG => DIR_ROW_FLAG | self.dir(),
            0x30 => 0x3f,
            0x0 => 0xf,
            _ => unreachable!(),
        }
